Config = {
    ...
    Uniforms = { -- Työ-Asu (Make {} for none)
        Male= {
    ...
    Garage = {X= 149.61, Y= 322.11, Z= 112.14}, -- Autotallin positioni
    VehicleSpawn = {X= 137.37, Y= 316.21, Z= 112.14, Heading= 115.0}, -- Positioni mihin auto spawnaa
    VehicleDelete = {X= 143.01, Y= 309.20, Z= 112.13}, -- Positioni mihin auto palautetaan

    Vehicles = { -- Kaikki autot mitkä voit spawnata menun kautta
        {Name= "Speedo 4", SpawnName= "speedo4"},
        {Name= "Sadler", SpawnName= "Sadler"}
    },
    LicensePlate = "Tech", -- Make "" for random text

    BlipName = "Työpaikkasi", -- Blipin nimi
    JobBlipName = "Kohteesi", -- Blipin nimi

    MoneyType = true, -- True= Cash | False= Bank
    MoneyAmount = 300, -- Rahan määrä kun suoritat yhden työ-tehtävän

    Translation = "FI", -- Kieli millä työ on

    Jobs = { -- Positionit työ-kohteisiin
    ...
    TranslationList = { -- List of all translation which you car choose
        ["FI"] = {
            ["LOCKER_HELP"] = "Paina ~INPUT_CONTEXT~ aukaistaksesi vaatekaappi!",
            ["LOCKER_MENU"] = "Vaatekaappi",
            ["WORK_CLOTHES"] = "Työasu",
            ["NORMAL_CLOTHES"] = "Siviiliasu",

            ["GARAGE_HELP"] = "Paina ~INPUT_CONTEXT~ avataksesi autotalli!",
            ["GARAGE_MENU"] = "Autotalli",
            ["GARAGE_PROBLEM"] = "~r~ Joku meni pieleen autoa spawnatessa. (Pysäytetty estämään kaatuminen!)",
            
            ["DELETE_HELP"] = "Paina ~INPUT_CONTEXT~ Palauttaaksesi auto firmalle!",

            ["MENU_HELP"] = "Paina ~INPUT_SELECT_CHARACTER_FRANKLIN~ Avataksesi Menu!",
            ["MENU_MENU"] = "Työmenu",
            ["MENU_NEW"] = "Ota uusi tehtävä",
            ["MENU_CREATED"] = "~g~ Sait uuden tehtävän. Katso se kartasta!",
            ["MENU_CANCEL"] = "Peruuta työsi",
            ["MENU_CANCELED"] = "~g~ Peruutit työsi!",
            ["MENU_ALREADY"] = "~r~ Sinä teet jo töitä. Peruuta keikka, niin voit valita uuden keikan",
            ["MENU_NONE"] = "~r~ Sinulla ei ole aktiivista keikkaa!",

            ["JOB_HELP"] = "Paina ~INPUT_CONTEXT~ katsoaksesi sähkökaappiin!",
            ["JOB_DONE"] = "~g~ Korjasit ongelman onnistuneesti. Sait rahaa tilillesi ~b~$300,-~g~ siitä hyvästä!"
        },
          ["EN"] = {
            ...
            ["JOB_DONE"] = "~g~ Succesfully fixed the problem. You have earned ~b~$300,-~g~ for it!"
        }
    }
}
